            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="login_admin.php" style="font-size: 25px; font-family: 'Brush Script MT', cursive ">Event Management Group(admin)</a>
                        </li>
                       <li class="nav-item">
                           <a class="nav-link active" href="register.php" style="font-family: 'Brush Script MT', cursive; font-size: 25px; ">Let's Continue</a>
                    </li>
                    </ul>
...
<div id="menu">
  ...
  <source src="wedding.mp4" type="video/mp4" width="100%" height="100%">
  Your browser does not support HTML5 video.
</video>
    <div id="welcome" style="margin-top:-355px; color: white;">
    
    <h2><center>Welcome to </center></h2>
    </br>
    <h1><center>Event Management Group</center></h1>
    <h3><center>with Moments,Today </center></h3>
   </div> 
    <br/>
    <br/>
</div>
     ...
     <section class="footer" style="margin-top:115px;" >
