  ...
  <nav class="navbar navbar-expand-lg navbar-light ">
    ...
    <center><h1>About Us</h1></center>
     <div class="about">
         ...
         <table width="100%">
            <tr>
                 <td width="45%" style="padding-left: 220px;">
                     <h1 >WHO WE ARE?</h1>
                     </br>
                     <p class="b">  We are an events management and travel company, which specialized in managing </br>events and tour.</p>
                <p>Welcome to EMG.</p>
                </br>
                </td>
                <td width="55%">
                   ...
                   <p class="b">Events Management Group (EMG) starting dated back at 1998 as a modest company focusing more on providing services in company events. Up-to-date, EMG had in fact served more than 1000 major corporations, hotels, societies and individual clients. 
        Now, EMG is a full-service provider of Event, Tour and Wedding Arrangement. EMG have all the reputable and qualify trainer plus appropriate venue and equipment to suits each and every single events.
                   </p>
    ...
    <table width="100%">
        ...
        <tr height="200px">
            <td width="20%">
                <img src="grab.png" height="150" width="280"class="center" >
            </td>
            <td width="20%">
                <img src="maybank.png" height="150" width="220"class="center">
            </td>
            <td width="20%">
                <img src="lazada.png" height="150" width="220"class="center">
            </td>
              <td width="20%">
         <center><img src="cimb.png" height="150" width="220"class="center" ></center>
              </td><!--  -->
        </tr>  
        <tr height="200px">
            <td width="20%">
                <img src="harvey norman.jpg" height="150" width="250"class="center" >
            </td>
            <td width="20%">
                <img src="coffee_bean.png" height="150" width="200"class="center">
            </td>
            <td width="20%">
                <img src="starbucks.png" height="150" width="200"class="center">
            </td>
              <td width="20%">
         <center><img src="Clarivate.jpg" height="150" width="220"class="center" ></center>
              </td><!--  -->
        </tr>  
        <tr height="200px">
            <td width="20%">
                <img src="jco.jpg" height="170" width="280"class="center" >
            </td>
            <td width="20%">
                <img src="koi.png" height="150" width="200"class="center">
            </td>
            <td width="20%">
                <img src="boost.png" height="120" width="200"class="center">
            </td>
              <td width="20%">
         <center><img src="bawang.jpg" height="170" width="220"class="center" ></center>
              </td><!--  -->
        </tr>  
    </table> 
...
</svg>jackleeleowgroup@gmail.com</a></p>
