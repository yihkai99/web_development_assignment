<?php
 if(isset($_POST["booking"])){
                ...
                $sql = "INSERT INTO booking (username, name, email_address, phone_number,event_type,event_place,guest_no,date,time)
                VALUES ('$username', '$name', '$email_address', '$phone_number', ' $event_type','$event_place','$guest_no','$date','$time' )";
       ...
       <h1 class="title"><center>Book An Apppointment</center></h1>
        ...
        <form action="#" method="POST"class="row g-3 needs-validation" novalidate>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="validationCustom01" name="Username" placeholder="Enter your username" required>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="validationCustom02" name="name"placeholder="Enter your name" required>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
           ...
           <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="validationCustom03" name="email_address" placeholder="Enter your email address" required>
                <div class="valid-feedback">
                    Looks good!
                </div>
                <div class="invalid-feedback">
            ...
            <h2 style="margin-top: 50px;text-align: center">Events Details </h2>
            
            
            
            <div class="col-md-6">
                <label for="validationCustom06" class="form-label">Event Type : </label>
                <select class="form-control form-select form-select-lg "name="type" id="validationCustom06" required>
            ...
            <div class="col-md-6">
                <label for="validationCustom07" class="form-label">Event Place : </label>
               <select class="form-control form-select form-select-lg "name="place" id="validationCustom07" required>
                ...
                <div class="invalid-feedback">
                      Please choose your event place.
                </div>
            </div>
            
            <div class="col-md-6">
                <label for="validationCustom08" class="form-label">No of guest : </label>
                <select class="form-control form-select form-select-lg "name="no" id="validationCustom08"required>
                            <option selected>Please select your no of guest</option>
                ...
                <div class="invalid-feedback">
                      Please write down number of guest.
                </div>
            </div>
                
            <div class="col-md-6">
                <label for="validationCustom09" class="form-label">Preferred Date : </label>
                <input type="date" id='date' name="date" class="form-control form-control-lg"name="date" id="validationCustom09" required>
            </div>
            
            <div class="col-md-6">
                <label for="validationCustom10" class="form-label">Preferred Time : </label>
                <input type="time" id='time' name="time" class="form-control form-control-lg"name="time" id="validationCustom10" required>
            </div>
